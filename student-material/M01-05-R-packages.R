...
# Learning objectives
# - Explore installed packages, their functions and vignettes
# - Loading a package and using it's functions
# - Namespacing a function
# - Checking what repository R is currently obtaining packages from
...
# You should see 'User Library' above the 'System Library' packages (scroll down to see). 
...
# What happens if we try to use a function without loading the package? Read the error
# message carefully
...
# Vignettes are long-form documentation, often user guides to a package.
